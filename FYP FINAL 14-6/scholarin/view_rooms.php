...
if (!empty($checkout) && $checkout < $today) {
    $checkout = '';
}
...
<body>
                ...
                <form id="filterForm" method="GET">
                    <div class="filter-grid">
                        <div class="field-group">
                            ...
                            <input type="date" id="checkin" name="checkin" value="<?php echo htmlspecialchars($checkin); ?>" min="<?php echo $today; ?>" required>
                        </div>
                        <div class="field-group">
                            <label for="checkout">Check-out Date</label>
                            <input type="date" id="checkout" name="checkout" value="<?php echo htmlspecialchars($checkout); ?>" min="<?php echo $checkin ? htmlspecialchars($checkin) : $today; ?>" required>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateCheckoutMin() {
            ...
            checkoutInput.min = checkinValue || '<?php echo $today; ?>';
        ...
        document.addEventListener('DOMContentLoaded', function() {
            applyLocation();
            updateCheckoutMin();
            document.getElementById('checkin').addEventListener('input', updateCheckoutMin);
        });
        ...
        document.getElementById('filterForm').addEventListener('submit', function(event) {
            ...
            if (checkout < checkin) {
                dateAlert.textContent = 'Check-out cannot be earlier than check-in.';
                dateAlert.classList.add('active');
                setTimeout(function() {
                    dateAlert.classList.remove('active');
                    dateAlert.textContent = 'Please choose a check-in and check-out date before booking.';
                }, 3200);
                return;
            }
