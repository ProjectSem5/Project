            ...
            <table>
                ...
                <?php mysqli_data_seek($rooms, 0); while($room = mysqli_fetch_assoc($rooms)): ?>
                    <tr>
                        ...
                        <td><?php if($room['image']): ?><img src="uploads/<?php echo htmlspecialchars($room['image']); ?>" alt="Room" style="width:100px; border-radius:10px;"><?php else: ?>No image<?php endif; ?></td>
                        <td class="actions">
            ...
            <table>
                ...
                <?php mysqli_data_seek($bookings, 0); while($row = mysqli_fetch_assoc($bookings)): ?>
                    <tr>
                        ...
                        <td><?php if(!empty($row['receipt'])): ?><a class="small-link" href="uploads/<?php echo htmlspecialchars($row['receipt']); ?>" target="_blank">View</a><?php else: ?>None<?php endif; ?></td>
                        <td>
